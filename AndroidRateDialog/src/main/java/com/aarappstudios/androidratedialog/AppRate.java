...
import static com.aarappstudios.androidratedialog.DialogManager.create;
import static com.aarappstudios.androidratedialog.PreferenceHelper.getInstallDate;
import static com.aarappstudios.androidratedialog.PreferenceHelper.getIsAgreeShowDialog;
import static com.aarappstudios.androidratedialog.PreferenceHelper.getLaunchTimes;
import static com.aarappstudios.androidratedialog.PreferenceHelper.getRemindInterval;
import static com.aarappstudios.androidratedialog.PreferenceHelper.isFirstLaunch;
import static com.aarappstudios.androidratedialog.PreferenceHelper.setInstallDate;
...
//        options.setNegativeText(negativeText);
    ...
    public void showDialogFromOutside(Activity activity)
    {
        create(activity, options).show();
    }
