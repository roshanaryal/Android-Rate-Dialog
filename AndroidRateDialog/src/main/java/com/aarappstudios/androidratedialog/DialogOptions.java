...
final class DialogOptions {
    ...
    private int messageResId = R.string.app_name;

    private int textPositiveResId = R.string.app_name;

    private int textNeutralResId = R.string.app_name;

    private int textNegativeResId = R.string.app_name;
